...
def dft_scf(folder, molecule, g16_path, level_of_theory, n_procs, logger):
    ...
    try:
        ...
        for charge in ['mulliken_charge', 'hirshfeld_charges', 'NPA_Charge']:
            ...
            # spin density
        for spin in ['mulliken_spin_density', 'hirshfeld_spin_density', 'NPA_spin_density']:
            ...
            QM_descriptor_return['{}_multiplicity'.format(spin)] = QM_descriptors['multiplicity'][spin]
